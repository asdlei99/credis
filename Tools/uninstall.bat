...
redis-sentinel\%portPre%05Stl\redis-stl.exe --service-uninstall --service-name %portPre%05Stl
%portPre%04Srv\redis-server.exe --service-uninstall --service-name %portPre%04Srv
